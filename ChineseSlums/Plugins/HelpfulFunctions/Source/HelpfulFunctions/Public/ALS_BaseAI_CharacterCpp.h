...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
		TEnumAsByte<CALS_Gait> GaitC;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
		TEnumAsByte<CALS_Gait> DesiredGaitC;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
		TEnumAsByte<CALS_OverlayState> OverlayStateC;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
		TEnumAsByte<CALS_Stance> StanceC;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
		TEnumAsByte<CALS_RotationMode> RotationModeC;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
		TEnumAsByte<CALS_MovementAction> MovementActionC;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
		TEnumAsByte<CALS_MovementState> MovementStateC;
	//Structures
	UPROPERTY(BlueprintReadWrite, meta = (AllowPrivateAccess = "True"))
